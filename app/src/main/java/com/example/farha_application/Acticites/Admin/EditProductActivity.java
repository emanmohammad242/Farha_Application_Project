...
public class EditProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productName_txt.setText(getIntent().getStringExtra("name"));
        productPrice_txt.setText(getIntent().getStringExtra("price"));
        productColor_txt.setText(getIntent().getStringExtra("color"));
        productSize_txt.setText(getIntent().getStringExtra("size"));
        productToken_txt.setText(getIntent().getStringExtra("token"));
        imageUrl_txt.setText(getIntent().getStringExtra("imageId"));
        productCategory_txt.setText(getIntent().getStringExtra("category"));
    }
    ...
    public void upDate_btn_OnClick(View view){
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            EditProductActivity.SendPostRequest runner = new SendPostRequest();
